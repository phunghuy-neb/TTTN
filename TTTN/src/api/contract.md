...
success : { success: true, contractVersion: 1, reply, decision: { action, operation, reason, requiredMissing, optionalMissing, assumptions, clarification }, tours, referencedTourIds, referencedBookingIds, constraintState, entityState, structuredContent, retrievalStatus?, providerStatus?: { status, code, providerAttempted, providerSucceeded, attemptCount, maxAttempts, retryCount, retryDelaysMs, failureClass, retryable?, httpStatus?, providerErrorStatus?, retryAfterMs?, retryStoppedReason?, fallbackUsed, finalComposer, provenanceClass, quotaMetric?, quotaId?, quotaLocation?, quotaModel?, quotaValue? }, outcome, warnings[] }
